...
from sample import Session, Blueprint, Deployment, FlavorMapping, ImageMapping, StorageProfile, NetworkProfile, \
	CloudZone, Project, CloudAccount, DataCollector, Project, CodeStream, ServiceBroker
...
def setup_org(bearer, data):
	...
	i = CloudAccount.createAzure(bearer, 'dev azure', data['azure_subscription_id'], data['azure_tenant_id'],
								 data['azure_application_id'], data['azure_application_key'])
