...
class CloudAccountvSphere(Account):
	...
	@staticmethod
	def createvSphere(session, name, fqdn, rdc, username, password, datacenter_moid, nsx_cloud_account='',
						description=''):
...
class ImageMapping(object):
	...
	@staticmethod
	def create(session, name="Ubuntu", image="Canonical:UbuntuServer:16.04-LTS:latest", region="dev azure / westus",
				description=None):
		# uri = '/iaas/image-profiles'
